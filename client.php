               ...
               <div class="container">
                  <div class="row">
                     <div class="col-md-6 col-sm-6">
                        <ul class="lan">
                           <li><i class="fa fa-globe" aria-hidden="true"></i> Desarrollo Web Profesional : </li>
                        </ul>
               ...
               <div class="container">
                  <div class="row d_flex">
                     <div class="col-md-4 col-sm-4 d_none">
                        <ul class="conta_icon">
                           <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i> Llamanos : 844-265-6937</a> </li>
                        </ul>
                     </div>
                     <div class="col-md-4 col-sm-4 " >
                        <a class="logo" href="#"><img src="5151151.png" alt="#"/></a>
                     </div>
                     <div class="col-md-4 col-sm-4 d_none">
                        <ul class="conta_icon ">
                            <li><a href="404.php"><i class="fa fa-envelope" aria-hidden="true"></i> Desarrolloweb@gmail.com</a> </li>
                        </ul>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item active">
                                    <a class="nav-link" href="client.php">Ayuda</a>
                                 </li>
                                 <li class="nav-item">
                     ...
                     <div class="col-md-3 col-sm-5 d_none">
                        <ul class="sign">
                           ...
                           <li><a class="sign_btn" href="#">Inicio de Sesión</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
      ...
      <div id="client"  class="testimonial">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2><strong class="yellow">Help</strong><br>¿En que podemos ayudarte?</h2>
                  </div>
               </div>
            </div>
         </div>
                     ...
                     <div class="carousel-caption ">
                        <div class="row">
                           <div class="col-md-6 offset-md-3">
                              <div class="test_box">
                                 <p>          Nuestra Oficina principal que puedes encontrarnos ubicados en:
                                                 Calle: Villa de Tierra alta, Colonia: Residencial los Pinos #987
                              </p>
                                 <i><img src="images/cos2.jpg" alt="#"/></i>         <span>Ubicación</span>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-md-6 offset-md-3">
                              <div class="test_box">
                                 <p>Correo elctronico: desarrolloweb@gmail.com </p>
                                 <i><img src="images/cos3.jpg" alt="#"/></i>         <span>Correo</span>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="container">
                     <div class="carousel-caption">
                        <div class="row">
                           <div class="col-md-6 offset-md-3">
                              <div class="test_box">
                                 <p>Numero de Telefono : 844-985-7869 extencion 36 </p>
                                 <i><img src="images/cos4.jpg" alt="#"/></i>         <span>Telefono</span>
                              </div>
                           </div>
                        </div>
                     </div>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-5 col-md-6 col-sm-6">
                     ...
                     <ul class="location_icon">
                        <li><a href="#"><i class="fa fa-map-marker" aria-hidden="true"></i></a> Desarrollo Web 
                           <br> Profesional
                        </li>
                  ...
                  <div class="col-lg-2 col-md-6 col-sm-6">
                     ...
                     <ul class="link_icon">
                        ...
                        <li> <a href="clients.html"></i>Ayuda</a></li>
                        <li class="active"> <a href="contact.html"></i>Contactanos</a></li>
                     </ul>
                  </div>
                  <div class="col-lg-2 col-md-6 col-sm-6">
                     <h3>Equipo</h3>
                     <ul class="link_icon">
                        <li > <a href="#"> Participantes del Equipo </a></li>
                        <li>
                           <a href="#">
                              Zidlain Guadalupe  
                        </li>
                        <li> <a href="#"> Gabriela Camacho </a></li>
                        <li> <a href="#"> Alejandra Martínez</a></li>
                        <li> <a href="#"> Mayo del 2023 </a></li>
                     </ul>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <h3>Hola excelente Día</h3>
