               ...
               <div class="container">
                  <div class="row d_flex">
                     <div class="col-md-4 col-sm-4 d_none">
                        <ul class="conta_icon">
                           <li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i> Llamanos : 844-985-7869</a> </li>
                        </ul>
                     </div>
      ...
      <div id="team" class="team">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2><strong class="yellow">Equipo </strong><br>El mejor equipo obvio.</h2>
                  </div>
               </div>
            </div>
            <div class="row">
         ...
         <div class="footer">
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>2023 Mayo 28 Equipo de Desarrollo Web<a href="https://html.design/"> Profesional</a></p>
                     </div>
                  </div>
               </div>
            </div>
